<template>
    ...
    >
        <p>Uh... so something went extremely wrong</p>
        <p class="text-gray-400" id="initializationFailedFooter">
            idk maybe check console for more info?
        </p>
    </div>
    <div
        class="w-full h-[calc(100%-80px)] flex gap-4 flex-col justify-center items-center"
...
let initializationFailed = $ref(false)
...
onBeforeMount(async () => {
    ...
    await new Promise(async (resolve, reject) => {
        ...
        .catch((e) => {
            ...
            console.error('Error while initializing composables', e)
            return
        })
